	...
	return (
		<div className="clawpress-header">
			<div className="clawpress-header-meta">
				<div className="clawpress-title">
					{ __( 'ClawPress Agent', 'clawpress' ) }
				</div>
				<div
					className={ `clawpress-status clawpress-status-${ resolvedStatusMode }` }
				>
					...
					{ statusLabel ? (
						<span className="clawpress-status-label">
							{ statusLabel }
						</span>
					) : null }
				</div>
