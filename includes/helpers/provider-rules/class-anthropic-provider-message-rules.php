<?php
/**
 * Anthropic provider message rules.
 *
 * @package ClawPress
 */
...
/**
 * Anthropic-specific generation option rules.
 */
final class Anthropic_Provider_Message_Rules implements Provider_Message_Rules {
	/**
	 * {@inheritDoc}
	 */
